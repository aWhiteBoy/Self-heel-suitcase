...
void Ov7725_exti_Init()
{
    ...
    //DMA通道0初始化，PTC12上升沿触发DMA传输，源地址为PTC_BYTE0_IN，目的地址为：BUFF ，每次传输1Byte，传输CAMERA_SIZE次后停止传输
    ...
    DMA_IRQ_EN(DMA_CH0);
    port_init(PTC10, IRQ_RISING| PULLUP | PF);    //场中断，下拉，下降沿触发中断，带滤波
...
{SDE          ,0x04},
{BRIGHT       ,0x00},                              
{CNST         ,30},//黑白图像阈值 150:楼上楼下都能跑（第一个车稳）70
{SIGN         ,0x06},
{UVADJ0       ,0x11},
{UVADJ1       ,0x02},
};
