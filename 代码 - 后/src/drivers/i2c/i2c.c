...
//void I2C_WriteAddr_Buffer(I2Cn i2cn, u8 SlaveID, u8 Addr, u8 Data, u16 num)
//{
//    /* send data to slave */
//    u16 i=0;
//    I2C_StartTransmission(i2cn, SlaveID, MWSR);    //启动传输
...
//    return result;
//}
//void I2C_ReadAddr__Buffer(I2Cn i2cn, u8 SlaveID, u8 *Addr, u8 *Data, u16 num)
//{
//  u16 i=0;
//  for(;i<num;i++)
//    *(Data+i) = I2C_ReadAddr(i2cn, SlaveID, *(Addr+i));
//}